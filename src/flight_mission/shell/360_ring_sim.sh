...
tmux send-keys -t ros_session:0.2 'sleep 4;  source ~/first_task_ws/devel/setup.bash; roslaunch usb_cam simple_camera_driver.launch' C-m
...
tmux send-keys -t ros_session:1.1 'sleep 5; source ~/first_task_ws/devel/setup.bash; roslaunch cloud_recognition all_noflag.launch' C-m

# Pane 3: complete_mission.launch
tmux split-window -v -t ros_session:1
tmux send-keys -t ros_session:1.2 'sleep 7; source ~/first_task_ws/devel/setup.bash; roslaunch flight_mission flight_mission.launch' C-m
